...
const ASMRStaticBackground: React.FC = () => {
  ...
  return (
    <div style={{ position: 'relative', width: '100vw', height: '100vh', backgroundColor: '#0a0a0c', cursor: 'none' }}>
      <canvas ref={canvasRef} style={{ position: 'absolute', top: 0, bottom: 0, left: 0, right: 0, display: 'block', width: '100%', height: '100%' }} />
    </div>
  );
};
